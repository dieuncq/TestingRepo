package com.exercise.studentmanageexercise.exception;

import com.exercise.studentmanageexercise.web.ResponseError;
import com.exercise.studentmanageexercise.web.ResponseMapper;
...
public class GlobalResponseException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleResourceNotFoundException(StudentNotFoundException ex) {
    ...
    public ResponseEntity<Object> handleEmailExistedException(EmailExistedException ex) {
